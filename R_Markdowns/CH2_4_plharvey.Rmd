...
![The plot above shows the thirteen games where the Mahalanobis Distances are outliers (>= 6.45) in red.](mahalanobis_ppg.jpeg)
...
Tests and summary statistics for the whole of the data:
```
...
Tests and summary statistics for only count data (number of shots made or missed):
```
Multivariate Normality
         Test       HZ     p value MVN
Henze-Zirkler 1.076262 0.001059446  NO

Univariate Normality
              Test  Variable Statistic   p value Normality
1 Anderson-Darling   Made1      2.3645  <0.001      NO    
2 Anderson-Darling   Miss1      5.3005  <0.001      NO    
3 Anderson-Darling   Made2      1.6544   3e-04      NO    
4 Anderson-Darling   Miss2      2.1229  <0.001      NO    
5 Anderson-Darling   Made3     10.4903  <0.001      NO    
6 Anderson-Darling   Miss3      4.6321  <0.001      NO    

Descriptive Statistics
        n      Mean  Std.Dev Median Min Max 25th 75th      Skew    Kurtosis
Made1 260  6.673077 3.822920      6   0  18    4    9 0.5716823 -0.06204798
Miss1 260  2.330769 1.615028      2   0   8    1    3 0.5535111  0.04338569
Made2 260 10.273077 3.347108     10   2  20    8   12 0.2854110  0.06643258
Miss2 260 10.450000 3.594478     10   2  24    8   12 0.6343559  1.01465995
Made3 260  1.592308 1.396057      1   0   7    1    2 1.0191962  0.92584185
Miss3 260  3.157692 1.542868      3   0   8    2    4 0.2767944 -0.03240609
```
As seen in the tests above, with a null hypothesis that the data are not MVN, and an alternate hypothesis that the data are MVN, we have a HZ test statistic of $\approx1.07$, giving a p-value of 0.00106.

The data provide statistically significant evidence for the null hypothesis, and we should accept that the data are not MVN.
...
If we were to engineer a variable that was the percentage of shots made/missed per game, in a fashion similar to 3.e. above, then the percentage data would no longer have linear dependence.

The plot below shows a Univariate Normal Quantile-Quantile plot for the average shot percentage by game. This appears approximately more normal, and intuitively we can understand this as the percentages are now aggregated at the game level.
